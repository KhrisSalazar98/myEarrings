            ...
            <div className='container'>
                <div className="row">
                    <div className="col-12 col-sm-12 col-lg-4 d-flex justify-content-center align-items-center">
                        <label className={`${selector.isChecked ? "" : "opcTheme"} form-check-label mt-3 mt-lg-0`} htmlFor="flexSwitchCheckDefault"><FontAwesomeIcon icon={faSun} size='xl' /></label>
                        ...
                        <label className={`${selector.isChecked ? "opcTheme" : ""} form-check-label mt-3 mt-lg-0`} htmlFor="flexSwitchCheckDefault"><FontAwesomeIcon icon={faMoon} size='xl' /></label>
                    </div>
